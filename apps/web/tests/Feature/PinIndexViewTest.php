...
test('pins page renders modal triggers and pin payload metadata', function () {
    ...
    expect($html)
        ...
        ->toContain("updateAction: '".str_replace('/', '\\/', route('dashboard.pins.update', ['pin' => '__PIN__']))."'")
        ...
        ->toContain('id="pin-title-desktop"')
        ->toContain('id="pin-title-mobile"')
        ->toContain('x-model="form.active"')
        ->toContain('id="pin-active-desktop"')
        ->toContain('id="pin-active-mobile"')
        ->toContain('name="active" value="0"')
        ->toContain('value="1"')
        ->toContain('toggle toggle-success')
        ->toContain('x-on:click="openDeleteConfirmation(')
        ->toContain('id="pin-delete-form-desktop"')
        ->toContain('id="pin-delete-form-mobile"')
        ->toContain('form="pin-delete-form-desktop"')
        ->toContain('form="pin-delete-form-mobile"')
        ->toContain('id="pin-delete-modal-title"')
        ->toContain('id="pin-delete-modal-title-mobile"')
        ->toContain('x-bind:action="deleteConfirmation.action"')
