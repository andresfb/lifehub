    ...
    <div @if(session('tfa-ttl')) x-data="twoFactorCountdown({{ (int) session('tfa-ttl') }})" @endif>
        ...
        @if(session('tfa-ttl'))
            <div class="mb-5 flex flex-col items-center gap-1">
                <div class="relative w-24 h-24">
                    <svg class="w-full h-full -rotate-90" viewBox="0 0 80 80">
                        ...
                        <circle
                            ...
                            r="34"
                            fill="none"
                            x-bind:stroke="hasExpired ? '#e54' : 'var(--lh-accent)'"
                            stroke-width="4"
                    ...
                    <span
                        x-text="text"
                        x-bind:class="{ 'text-[#e54]': hasExpired, 'text-(--lh-text)': ! hasExpired }"
                ...
                <p x-text="label" class="text-[12px] text-(--lh-text-muted)">{{ __('remaining') }}</p>
            </div>
        @endif
