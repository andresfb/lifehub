...
/**
 * V1Login203Response Class Doc Comment
 *
 * @category Class
 * @package  LifeHub\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class V1Login203Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'v1_login_203_response';
    ...
    public const MESSAGE_TWO_FACTOR_AUTHENTICATION_REQUIRED = 'Two-factor authentication required';
    ...
    {
        return [
            self::MESSAGE_TWO_FACTOR_AUTHENTICATION_REQUIRED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['two_factor'] === null) {
            $invalidProperties[] = "'two_factor' can't be null";
        }
     ...
     * Sets two_factor
     *
     * @param bool $two_factor two_factor
     *
     * @return self
     */
