...
/**
 * V1Logout200Response Class Doc Comment
 *
 * @category Class
 * @package  LifeHub\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class V1Logout200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'v1_logout_200_response';
    ...
    public const MESSAGE_TOKEN_REVOKED_SUCCESSFULLY = 'Token revoked successfully';
    ...
    {
        return [
            self::MESSAGE_TOKEN_REVOKED_SUCCESSFULLY,
        ];
    }
