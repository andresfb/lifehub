...
class RegisterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['invitation'] === null) {
            $invalidProperties[] = "'invitation' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RegisterRequest., must be smaller than or equal to 255.');
        }
